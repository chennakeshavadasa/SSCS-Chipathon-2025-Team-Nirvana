...
N 510 -240 570 -240 {lab=VGN}
N 510 -320 510 -240 {lab=VGN}
N 510 -350 610 -350 {lab=VGN}
...
N 610 -290 610 -270 {lab=#net1}
N 510 -350 510 -320 {lab=VGN}
N 610 -380 610 -350 {lab=VGN}
N 780 -370 820 -370 {lab=VGP}
N 780 -370 780 -310 {lab=VGP}
N 780 -310 860 -310 {lab=VGP}
N 860 -340 860 -310 {lab=VGP}
N 860 -400 860 -370 {lab=#net2}
N 860 -220 860 -170 {lab=GND}
N 860 -310 860 -280 {lab=VGP}
N 860 -490 860 -470 {lab=VDD}
N 860 -410 860 -400 {lab=#net2}
...
N 1340 -300 1340 -270 {lab=#net4}
N 1340 -390 1340 -370 {lab=VDD}
N 1340 -310 1340 -300 {lab=#net4}
...
N 480 -180 480 -150 {lab=#net5}
N 400 -150 440 -150 {lab=VDD}
N 400 -200 400 -150 {lab=VDD}
N 400 -220 400 -200 {lab=VDD}
N 400 -250 480 -250 {lab=VDD}
N 480 -250 480 -240 {lab=VDD}
N 400 -250 400 -220 {lab=VDD}
N 480 -120 480 -80 {lab=GND}
N 1340 -120 1820 -120 {lab=GND}
N 1820 -200 1820 -120 {lab=GND}
N 1820 -370 1820 -260 {lab=Vout}
N 1340 -490 1820 -490 {lab=VDD}
N 1820 -490 1820 -430 {lab=VDD}
N 1600 -400 1640 -400 {lab=VGP}
N 1700 -400 1780 -400 {lab=#net6}
N 1820 -430 1820 -400 {lab=VDD}
N 1600 -230 1640 -230 {lab=VGN}
N 1700 -230 1780 -230 {lab=#net7}
N 1820 -230 1820 -200 {lab=GND}
N 1960 -300 1960 -280 {lab=Vout}
N 1960 -310 1960 -300 {lab=Vout}
N 1820 -310 1960 -310 {lab=Vout}
N 1960 -220 1960 -120 {lab=GND}
N 1820 -120 1960 -120 {lab=GND}
...
C {symbols/nfet_03v3.sym} 460 -150 0 0 {name=M5
L=0.5u
W=5u
nf=1
m=8
...
C {devices/vdd.sym} 480 -250 0 0 {name=l1 lab=VDD}
C {devices/ammeter.sym} 480 -210 0 0 {name=Vmeas4 savecurrent=true spice_ignore=0}
C {devices/gnd.sym} 480 -80 0 0 {name=l2 lab=GND}
C {symbols/pfet_03v3.sym} 1800 -400 0 0 {name=M6
L=0.5u
W=15.375u
nf=1
m=8
...
C {symbols/nfet_03v3.sym} 1800 -230 0 0 {name=M7
L=0.5u
W=5u
nf=1
m=8
...
C {devices/vsource.sym} 1670 -400 1 0 {name=V2 value="0 ac 1" savecurrent=false}
C {devices/lab_pin.sym} 780 -370 0 0 {name=p1 sig_type=std_logic lab=VGP}
C {devices/lab_pin.sym} 1600 -400 0 0 {name=p2 sig_type=std_logic lab=VGP}
C {devices/lab_pin.sym} 510 -340 0 0 {name=p3 sig_type=std_logic lab=VGN}
C {devices/lab_pin.sym} 1600 -230 0 0 {name=p4 sig_type=std_logic lab=VGN}
C {devices/vsource.sym} 1670 -230 1 0 {name=V3 value="0 ac 1" savecurrent=false}
C {devices/capa.sym} 1960 -250 0 0 {name=C1
m=1
value=250p
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 1960 -310 0 1 {name=p5 sig_type=std_logic lab=Vout}
